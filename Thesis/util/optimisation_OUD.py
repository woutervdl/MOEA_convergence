...
global_JUSTICE_ref_set = pd.read_csv("../hpc/global_ref_set.csv")
    ...
    if problem.name == 'JUSTICE':
        try:
            ...
            hv_results = calculate_hypervolume_from_archives(
                ...
                global_reference_set_path="Thesis/hpc",
                global_reference_set_file="global_ref_set.csv"
            )
            ...
            use_custom_hv = False
    elif problem.name == 'DTLZ2' or problem.name == 'DTLZ3':
        use_custom_hv = False
...
def analyse_convergence(results, model, algorithm_names, seeds, core_count=None):
    ...
    if hasattr(model, 'generate_true_pareto_solutions'):
        ...
        reference_set = global_JUSTICE_ref_set
