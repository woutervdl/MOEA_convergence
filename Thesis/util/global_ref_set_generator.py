...
# Settings
justice_root = "../hpc/OLD_RESULTS/JUSTICE"
...
for cores in core_counts:
    for moea in moeas:
        for seed in seeds:
            h5_path = os.path.join(justice_root, f"{cores}cores", moea, seed, f"results_JUSTICE_{moea}_{cores}cores_{seed}.h5")
...
# Save result
csv_output = "../hpc/global_ref_set.csv"
